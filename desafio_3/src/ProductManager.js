...
// pcComponents.addProduct("producto prueba1", "Este es un producto prueba1",200, "Sin imagen", "abc123", 55);
// pcComponents.addProduct("producto prueba2", "Este es un producto prueba2",100, "Sin imagen", "abc223", 65);
// pcComponents.addProduct("producto prueba3", "Este es un producto prueba3",400, "Sin imagen", "abc233", 5);
// pcComponents.addProduct("producto prueba4", "Este es un producto prueba4",300, "Sin imagen", "abc333", 15);
// pcComponents.addProduct("producto prueba5", "Este es un producto prueba5",900, "Sin imagen", "abc433", 65);
// pcComponents.addProduct("producto prueba6", "Este es un producto prueba6",800, "Sin imagen", "abc443", 75);
// pcComponents.addProduct("producto prueba7", "Este es un producto prueba7",700, "Sin imagen", "abc444", 85);
// pcComponents.addProduct("producto prueba8", "Este es un producto prueba8",400, "Sin imagen", "abc544", 45);
// pcComponents.addProduct("producto prueba9", "Este es un producto prueba9",500, "Sin imagen", "abc554", 35);
// pcComponents.addProduct("producto prueba10", "Este es un producto prueba10",100, "Sin imagen", "abc555", 250);

//pcComponents.getProducts();

//pcComponents.getProductById(1);

//pcComponents.updateProduct(1,'','','','','',50);
